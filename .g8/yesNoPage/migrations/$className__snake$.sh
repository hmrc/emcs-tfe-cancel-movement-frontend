...
echo "$className;format="decap"$.checkYourAnswers.label = $className;format="decap"$" >> ../conf/messages.en
...
echo "$className;format="decap"$.checkYourAnswers.label = $className;format="decap"$" >> ../conf/messages.cy
