  ...
  "MoreInformationView" - {
    ...
    Seq(MoreInformationMessages.English, MoreInformationMessages.Welsh).foreach { messagesForLanguage =>
      ...
      s"when being rendered in lang code of '${messagesForLanguage.lang.code}'" - {
        ...
        val form = app.injector.instanceOf[MoreInformationFormProvider].apply(isMandatory = false)

        implicit val doc: Document = Jsoup.parse(view(form, testOnwardRoute, isMandatory = false).toString())
