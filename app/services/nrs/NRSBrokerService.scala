...
import models.nrs.{CancelMovementNRSSubmission, IdentityData, NRSPayload}
...
class NRSBrokerService @Inject()(brokerConnector: NRSBrokerConnector,
  ...
  def submitPayload(submission: SubmitCancelMovementModel, ern: String)
    ...
    val submissionAsString = Json.stringify(Json.toJson(CancelMovementNRSSubmission(ern, submission)))
